...
class _RegisterScreenState extends State<RegisterScreen> with InputFieldMixin {
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: SecondaryButton(
                    onClick: () {
                      // navigate to create username screen
                      Navigator.pushNamed(context, CreateUserNameScreen
                          .routeName);
                    },
                    fontSize: _fontSM,
                    text: 'Next',
